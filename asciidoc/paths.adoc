...
|**CreditLine** +
__optional__|Set of elements used to provide details on the credit line.|< <<_balance_creditline,CreditLine>> > array
|**DateTime** +
...
|Name|Description|Schema
|**Amount** +
__optional__|Amount of money of the credit line.|<<_balance_creditline_amount,Amount>>
|**Included** +
