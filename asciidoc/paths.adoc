...
|**Account** +
__required__|Provides the details to identify an account.|<<_accounts_get_data_account,Account>>
|**AccountId** +
...
**Length** : `1 - 70`|string
|**Servicer** +
__required__|Party that manages the account on behalf of the account owner, that is manages the registration and booking of entries on the account, calculates balances on the account and provides information about the account.|<<_accounts_get_data_servicer,Servicer>>
|===
...
|Name|Description|Schema
|**Permissions** +
__required__|Specifies the Open Banking account request types. This is a list of the data clusters being consented by the PSU, and requested for authorisation with the ASPSP.|< object > array
...
|===
|HTTP Code|Description|Schema
|**201**|Account Request resource successfully created|<<_account_request_post_request,Account Request POST request>>
|**400**|Bad Request|No Content
|**401**|Unauthorized|No Content
|**403**|Forbidden|No Content
...
|**Status** +
__optional__|Specifies the status of the account request resource in code form.|enum (TBD)
|**TransactionFromDateTime** +
__optional__|Specified start date and time for the transaction query period. If this is not populated, the request will be open ended.|string (date-time)
|**TransactionToDateTime** +
__optional__|Specified end date and time for the transaction query period. If this is not populated, the request will be open ended.|string (date-time)
...
**Length** : `1 - 40`|string
|**CreditorAccount** +
__required__||<<_accounts_accountid_beneficiaries_get_data_creditoraccount,CreditorAccount>>
...
|Name|Description|Schema
|**data** +
__required__|Array of Direct Debits|< <<_accounts_accountid_direct-debits_get_data,data>> > array
|**links** +
__optional__||<<_accounts_accountid_direct-debits_get_links,links>>
|**meta** +
__required__||<<_accounts_accountid_direct-debits_get_meta,meta>>
|===
...
[[_accounts_accountid_direct-debits_get_meta]]
**meta**
...
|Name|Description|Schema
|**data** +
__required__|Array of Standing Orders|< <<_accounts_accountid_standing-orders_get_data,data>> > array
|**links** +
__optional__||<<_accounts_accountid_standing-orders_get_links,links>>
|**meta** +
__required__||<<_accounts_accountid_standing-orders_get_meta,meta>>
|===
...
**Length** : `1 - 40`|string
|**CreditorAccount** +
__required__|Provides the details to identify the beneficiary account.|<<_accounts_accountid_standing-orders_get_data_creditoraccount,CreditorAccount>>
|**CreditorReferenceInformation** +
__optional__|Unique reference, as assigned by the creditor, to unambiguously refer to the payment transaction. Usage: If available, the initiating party should provide this reference in the structured remittance information, to enable reconciliation by the creditor upon receipt of the amount of money. If the business context requires the use of a creditor reference or a payment remit identification, and only one identifier can be passed through the end-to-end chain, the creditor's reference or payment remittance identification should be quoted in the end-to-end transaction identification. +
**Length** : `1 - 35`|string
|**FinalPaymentAmount** +
...
[[_accounts_accountid_standing-orders_get_meta]]
**meta**
...
|**Balance** +
__required__|Set of elements used to define the balance as a numerical representation of the net increases and decreases in an account after a transaction entry is applied to the account.|<<_accounts_accountid_transactions_get_data_balance,Balance>>
|**BankTransactionCode** +
...
**Length** : `1 - 40`|string
|**CreditorAccount** +
__required__||<<_beneficiaries_get_data_creditoraccount,CreditorAccount>>
|**CreditorReferenceInformation** +
__optional__|Unique reference, as assigned by the creditor, to unambiguously refer to the payment transaction. Usage: If available, the initiating party should provide this reference in the structured remittance information, to enable reconciliation by the creditor upon receipt of the amount of money. If the business context requires the use of a creditor reference or a payment remit identification, and only one identifier can be passed through the end-to-end chain, the creditor's reference or payment remittance identification should be quoted in the end-to-end transaction identification. +
**Length** : `1 - 35`|string
|**Servicer** +
...
|Name|Description|Schema
|**data** +
__required__|Array of Direct Debits|< <<_direct-debits_get_data,data>> > array
|**links** +
__optional__||<<_direct-debits_get_links,links>>
|**meta** +
__required__||<<_direct-debits_get_meta,meta>>
|===
...
|Name|Description|Schema
|**data** +
__required__|Array of Standing Orders|< <<_standing-orders_get_data,data>> > array
|**links** +
__optional__||<<_standing-orders_get_links,links>>
|**meta** +
__required__||<<_standing-orders_get_meta,meta>>
|===
...
**Length** : `1 - 40`|string
|**CreditorAccount** +
__required__|Provides the details to identify the beneficiary account.|<<_standing-orders_get_data_creditoraccount,CreditorAccount>>
|**CreditorReferenceInformation** +
__optional__|Unique reference, as assigned by the creditor, to unambiguously refer to the payment transaction. Usage: If available, the initiating party should provide this reference in the structured remittance information, to enable reconciliation by the creditor upon receipt of the amount of money. If the business context requires the use of a creditor reference or a payment remit identification, and only one identifier can be passed through the end-to-end chain, the creditor's reference or payment remittance identification should be quoted in the end-to-end transaction identification. +
**Length** : `1 - 35`|string
|**FinalPaymentAmount** +
...
|**Balance** +
__required__|Set of elements used to define the balance as a numerical representation of the net increases and decreases in an account after a transaction entry is applied to the account.|<<_transactions_get_data_balance,Balance>>
|**BankTransactionCode** +
